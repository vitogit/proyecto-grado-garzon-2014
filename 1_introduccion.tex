...
Dado que se pretende modelar es el tráfico vehicular y transporte público no se realiza una simulación de peatones.


\section{Aportes}

\begin{itemize}
	\item Se desarrolló un sitio web en la siguiente dirección: \url{http://www.fing.edu.uy/inco/grupos/cecal/hpc/AECG} donde los interesados podrán acceder a información sobre el proyecto y los resultados. 
