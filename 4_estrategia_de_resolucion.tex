...
La ubicación y líneas de cada parada se obtuvo de \citep{sigMontevideo}. Existen 14 paradas de líneas urbanas por el corredor para el recorrido de ida y la misma cantidad para la vuelta.
