...
Este capítulo explica el proceso llevado a cabo para desarrollar la solución. La metodología se basa en tres puntos, estos son: el modelado del problema, el algoritmo genético desarrollado y la simulación del trafico.
