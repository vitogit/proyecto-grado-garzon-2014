...
A continuación se detallan los puntos destacados del modelo.
...
Para establecer la velocidad media de los ómnibus se realizo un estudio basado en datos de GPS proporcionados por la IMM luego de reuniones con Ingeniería de Transito.
