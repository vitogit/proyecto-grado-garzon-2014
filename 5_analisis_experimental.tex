...
La linea G es la que recorre a Garzón de punta a punta, esta línea es cubierta por Coectc y Cutcsa. Una posibilidad de alternancia de paradas consiste en dividir las paradas por empresa y compartiendo las ganancias del corredor o mediante algun metodo para equiparar el pasaje. Una empresa se detendrá en las paradas pares y la otra en las impares. Si se reduce el numero de paradas que hace un ómnibus, aumentará su velocidad promedio y al cubrir la misma cantidad de paradas entre las dos empresas no se deberá resentir en demasía el servicio ya que la disminución de la frecuencia en una parada se contrarresta con el aumento promedio de velocidad.

Esto se justifica pues uno de los problemas del ómnibus es su baja aceleración por lo que cada vez que este frena en un semáforo o en una parada demora en retomar una velocidad aceptable. Por tanto al reducir la cantidad de paradas que un ómnibus tiene que hacer se mejora la velocidad promedio.
