...
\begin{table}[h]
	...
	\begin{tabular}{ccrrcr}
	   ...
	   \multirow{2}{*}{\textbf{Población}}& & 
		...
		& & {mejor} 
		& {promedio} 
		& \textbf{Tiempo de ejecución (m)} \\
		\hline
		32 & & {17.28} & 16.37$\pm$0.5 & 4853\\
		48 & & {16.19} & 15.84$\pm$0.3 & 6772\\
		64 & & {17.27} & 16.46$\pm$0.6 & 10184\\
		\hline
	\end{tabular}
\end{table}
...
\begin{table}[h]
	\renewcommand{\arraystretch}{1.2}
	\caption{Mejoras obtenidas al aplicar el algoritmo sobre el escenario alternativo. Comparando las velocidades de ómnibus(vpb), otros vehículos(vpv) y el fitness con cada tipo de trafico contra el caso base o realidad actual.}
