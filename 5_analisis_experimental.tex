...
SE aplica el criterio de significancia estadistaica para validar los resultados. Para cada uno de los casos se comprueba de que existe evidencia estadistica que se mejoran los resultados al utilizar el algoritmo.

(agregar formular)

Esto significa que un viaje en omnibus del principio al fin del corredor (6.5km) duraba 27min en el caso base y luego del algoritmo se mejora hasta 23.5min en una situacion de trafico alto. En el caso de un viaje en auto la duracion era de 14.8min y luego del algoritmo 11.8min.
