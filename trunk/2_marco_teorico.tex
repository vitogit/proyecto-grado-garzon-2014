...
http://dialnet.unirioja.es/servlet/articulo?codigo=3119987
...
\begin{figure}[h]
	...
	\caption{Gráfica de costos de transporte en funcion de la gente transportada, BRT (Bus Rapid Transit), LRT(Light Rail Train), .- Imagen original extraida de http://www.nbrti.org/docs/pdf/ITDP%20BRT%20Planning%20Guide.pdf"}
		\label{fig:Grafica de costos de otros medios de transporte}
	\end{figure}
	
\subsection{Corredor de Garzon}	
