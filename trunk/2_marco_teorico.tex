...
\end{itemize}
Desde su construcción el corredor a recibido críticas debido a que su principal objetivo era agilizar el transporte público no fue cumplido, esto fue admitido por las autoridades \citep{olivera2015}.Y luego de intentos de mejoras al respecto según las autoridades se ha vuelto a la velocidad promedio antes de realizar el corredor (para el transporte público).
