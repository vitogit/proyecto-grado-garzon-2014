...
Se utiliza el AG provisto por la biblioteca Malva llamado "NewGA", con las modificaciones detalladas en el capítulo anterior. El siguiente esquema describe el funcionamiento del algoritmo utilizado:
...
\begin{figure}[H]
	...
	\caption{Nueva función agrega al código provisto por Malva.}
	\label{fig:codigo1}
\end{figure}
