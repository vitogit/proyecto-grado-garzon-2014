...
Se utiliza el algoritmo genético provisto por la biblioteca Malva llamado "NewGA", con las modificaciones detalladas en el capítulo anterior. El siguiente esquema describe el funcionamiento del algoritmo utilizado:
